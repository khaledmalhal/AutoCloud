        ...
        try:
            ...
            while True:
                try:
                    ...
                    '''
                    self.LMR=0x00
                    if self.IR01_GPIO.read() != True: #True follow black line
                        self.LMR=(self.LMR | 4) #turn left
                    if self.IR02_GPIO.read() != True: #True follow black line
                        self.LMR=(self.LMR | 2) #go straight on
                    if self.IR03_GPIO.read() != True: #True follow black line
